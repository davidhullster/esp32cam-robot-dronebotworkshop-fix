...
void robot_setup()
{
    ...
    // Motor uses PWM Channel 8 - using standard ESP-IDF LEDC functions
    ...
    ledc_channel.gpio_num = MTR_PWM;
    ledc_channel.duty = 130;
...
void update_speed()
{  
    ledc_set_duty(LEDC_LOW_SPEED_MODE, LEDC_CHANNEL_0, get_speed(motor_speed));
    ledc_update_duty(LEDC_LOW_SPEED_MODE, LEDC_CHANNEL_0);
}
